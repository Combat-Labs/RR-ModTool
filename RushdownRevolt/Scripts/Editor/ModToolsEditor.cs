    ...
    public class ModToolsEditor : EditorWindow
{
    ...
    private static string ExportPath { get { return Directory.GetCurrentDirectory() + "\\Exported"; } }
    private static string CatalogPath { get { return Directory.GetCurrentDirectory() + "\\Library\\com.unity.addressables\\aa\\" + CurrentBuildTarget + "\\catalog.json"; } }
    private static string ModSavePath { get { return Directory.GetCurrentDirectory() + "\\Mods"; } }
    ...
    private void OnEnable()
    {
        ...
        _addressableSettings = new SerializedObject(AssetDatabase.LoadAssetAtPath<AddressableAssetSettings>("Assets/AddressableAssetsData/AddressableAssetSettings.asset"));
    ...
    private void OnGUI()
    {
        ...
        if(_layer16.stringValue != LAYER_NAME)
        {
            ...
            EditorGUILayout.LabelField(_layer16.stringValue.IsNullOrEmpty() ? "EMPTY" : _layer16.stringValue, EditorGUILayoutExtentions.GUIStyleColor(Color.red));
        ...
        {
            EditorGUILayout.LabelField("Please enter a name for your mod", EditorGUILayoutExtentions.GUIStyleColor(Color.red));
        }
        EditorGUILayoutExtentions.LineSeparator();
    }
    ...
    private static void CleanMods()
    {
        ...
        {
            Directory.Delete(Directory.GetCurrentDirectory() + "\\Assets\\AddressableAssetsData\\AssetGroups", true);
            AssetDatabase.Refresh();   
        }
    }
